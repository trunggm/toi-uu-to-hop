...
function init() {
	...
	gapi.client.load('qhdendpoint', 'v1', loadCallback, rootpath);
}
...
function qhd() {
	...
	var request = gapi.client.qhdendpoint.qhd({'input': input});
	request.execute(qhdCallback);
}

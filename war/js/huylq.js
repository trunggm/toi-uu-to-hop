...
function init() {
	...
	gapi.client.load('tabusearchendpoint', 'v1', loadCallback, rootpath);
}
...
function tbs() {
	...
	var request = gapi.client.tabusearchendpoint.tbs({'input': input});
	request.execute(tbsCallback);
}

function tbsCallback(response) {

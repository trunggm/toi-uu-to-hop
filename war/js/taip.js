...
function init() {
	...
	gapi.client.load('acoendpoint', 'v1', loadCallback, rootpath);
}
...
function aco() {
	...
	var request = gapi.client.acoendpoint.aco({'input': input});
	request.execute(acoCallback);
}

function acoCallback(response) {
